...
import type { CharacterDefinition, BackgroundDefinition, ClassDefinition, EquipmentSlot, GameState, Item, NpcRuntimeState, Quest, RaceDefinition, SpecialPathDefinition } from '@neon-ether/game-schema';
...
export const CharacterSheet: React.FC<CharacterSheetProps> = ({ state, resolvedPlayer, playerRace, playerBackground, raceNames, primaryClass, specialPaths, items, quests, party, progression, equipmentOptions, equipmentSlots, onClose, onEquip, onUnequip, onUse, onDrop }) => {
  ...
  return <section className="ne-character-sheet" data-tab={tab} aria-label="Character sheet">
    ...
    <div className="ne-sheet-body">
      {tab === 'character' && <CharacterTab state={state} resolvedPlayer={resolvedPlayer} progression={progression} playerRace={playerRace} playerBackground={playerBackground} primaryClass={primaryClass} specialPaths={specialPaths}/>}
