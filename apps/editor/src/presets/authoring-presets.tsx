...
export const DEFAULT_AUTHORING_PRESETS: AuthoringPreset[] = [
  ...
  { id: 'preset_relationship_choice', name: 'Relationship Choice', kind: 'eventChoice', tags: ['choice', 'relationship'], payload: { id: 'choice_new', text: 'Relationship choice', presentationType:'Normal', conditions: [], effects: [{ type: 'changeRelationship', npcId: '', delta: 5 }], hideIfUnavailable: false } },
