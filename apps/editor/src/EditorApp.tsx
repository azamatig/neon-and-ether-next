...
function createTemplate(category: Category, id: string): EditableEntity {
  ...
  if(category==='classes')return{id,name:'New Class',description:'',tags:[],isAvailable:false,requirements:[],startingAbilityIds:[],startingSkillModifiers:{},startingModifiers:[],startingEquipment:[],grantedTraits:[],startingEffects:[]} as EditableEntity;
