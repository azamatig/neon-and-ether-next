...
export const GameApp: React.FC = () => {
  ...
  else if (isResult) content=<CombatResultContainer resolution={runtime.activeCombatResolution!} resolveItemName={runtime.entityNames.item} onTakeLoot={runtime.takeLoot} onExecutePostCombatAction={runtime.executePostCombatAction} onDismiss={runtime.dismissCombatResult} onLoadLastSave={()=>runtime.loadFromLocalSlot('Slot 1').success} onMainMenu={()=>setShowMainMenu(true)}/>;
  ...
  else if (isScreen && gameState.world.activeScreen==='Workbench') content=<CraftingScreen recipes={runtime.recipes} availableIds={runtime.availableRecipeIds} inventory={gameState.player.inventory} resolveItemName={runtime.entityNames.item} onCraft={runtime.craftRecipe} onReturn={runtime.returnToOrigin}/>;
