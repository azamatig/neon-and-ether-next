...
- Gameplay RNG is now serialized and seed-deterministic; balancing still needs distribution telemetry across many seeded runs.
...
1. Add seeded distribution telemetry for combat, loot, and conditional content rolls.
