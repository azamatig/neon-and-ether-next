...
function createTemplate(category: Category, id: string): EditableEntity {
  ...
  if(category==='races')return{id,name:'New Race',description:'',tags:[],isAvailable:false,requirements:[],attributeModifiers:[],skillModifiers:{},grantedTraits:[],grantedAbilityIds:[],startingEffects:[]} as EditableEntity;
