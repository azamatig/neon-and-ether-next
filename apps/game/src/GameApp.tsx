...
export const GameApp: React.FC = () => {
  ...
  else if (isCombat) content=<TurnBasedCombatScreen state={gameState.combat} commands={runtime.combatCommands} abilities={runtime.combatAbilities} items={runtime.itemDefinitions} onCommand={runtime.executeCombatAction}/>;
