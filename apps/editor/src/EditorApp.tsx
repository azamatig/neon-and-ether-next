...
type Category = 'minigames' | 'backgrounds' | 'races' | 'classes' | 'specialPaths' | 'namePools' | 'items' | 'npcs' | 'enemies' | 'factions' | 'pois' | 'events' | 'quests' | 'maps' | 'encounters' | 'rooms' | 'bases' | 'baseUpgrades' | 'baseJobs' | 'recipes' | 'shops' | 'weatherDefinitions' | 'weatherProfiles';
