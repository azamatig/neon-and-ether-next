...
type Category = 'items' | 'npcs' | 'enemies' | 'factions' | 'pois' | 'events' | 'quests' | 'maps' | 'encounters' | 'rooms' | 'bases' | 'baseUpgrades' | 'baseJobs' | 'recipes' | 'shops';
type EditableEntity = GameContent[Category][number];

const CATEGORY_LABELS: Record<Category, string> = { items: 'Items', npcs: 'NPCs', enemies: 'Enemies', factions:'Factions', pois: 'POIs', events: 'Events', quests: 'Quests', maps: 'Maps', encounters: 'Encounters', rooms: 'Base Rooms', bases: 'Bases', baseUpgrades: 'Upgrades', baseJobs: 'Base Jobs', recipes: 'Recipes', shops: 'Shops' };
