...
import { type DiceRollResult, type RandomSource } from '@neon-ether/engine';
...
export function resolveStatCheck(stat:PrimaryStat,attributes:CharacterAttributes,difficulty:StatCheckDifficulty,roller:RandomSource,customDc?:number,contextLabel?:string):StatCheckResolution {
