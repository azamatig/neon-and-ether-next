...
export const GameApp: React.FC = () => {
  ...
  else if (isResult) content=<CombatResultContainer resolution={runtime.activeCombatResolution!} items={runtime.itemDefinitions} resolveItemName={runtime.entityNames.item} onTakeLoot={runtime.takeLoot} onExecutePostCombatAction={runtime.executePostCombatAction} onDismiss={runtime.dismissCombatResult} onLoadLastSave={()=>runtime.loadFromLocalSlot('Slot 1').success} onMainMenu={()=>setShowMainMenu(true)}/>;
