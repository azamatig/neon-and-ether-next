...
export const CharacterSheet: React.FC<CharacterSheetProps> = ({ state, resolvedPlayer, items, quests, party, progression, equipmentOptions, onClose, onEquip, onUnequip, onUse, onDrop }) => {
