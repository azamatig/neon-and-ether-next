...
import { BaseJobDefinition, BaseJobDefinitionSchema, BaseRoomDefinition, BaseRoomDefinitionSchema, BaseUpgradeDefinition, BaseUpgradeDefinitionSchema, CombatEncounter, CombatEncounterSchema, EnemySchema, GameContent, GameEvent, GameEventSchema, GameMap, GameMapSchema, ItemSchema, NPCSchema, PlayerBaseDefinition, PlayerBaseDefinitionSchema, POI, POISchema, RecipeSchema, ShopDefinitionSchema, Quest, QuestSchema, ValidationIssue } from '@neon-ether/game-schema';
...
type Category = 'items' | 'npcs' | 'enemies' | 'pois' | 'events' | 'quests' | 'maps' | 'encounters' | 'rooms' | 'bases' | 'baseUpgrades' | 'baseJobs' | 'recipes' | 'shops';
type EditableEntity = GameContent[Category][number];

const CATEGORY_LABELS: Record<Category, string> = { items: 'Items', npcs: 'NPCs', enemies: 'Enemies', pois: 'POIs', events: 'Events', quests: 'Quests', maps: 'Maps', encounters: 'Encounters', rooms: 'Base Rooms', bases: 'Bases', baseUpgrades: 'Upgrades', baseJobs: 'Base Jobs', recipes: 'Recipes', shops: 'Shops' };
const CATEGORY_SCHEMAS = { items: ItemSchema, npcs: NPCSchema, enemies: EnemySchema, pois: POISchema, events: GameEventSchema, quests: QuestSchema, maps: GameMapSchema, encounters: CombatEncounterSchema, rooms: BaseRoomDefinitionSchema, bases: PlayerBaseDefinitionSchema, baseUpgrades: BaseUpgradeDefinitionSchema, baseJobs: BaseJobDefinitionSchema, recipes: RecipeSchema, shops: ShopDefinitionSchema } as const;
